...
class AmpOptimizer:
    ...
    def load_state_dict(self, state, strict=True):
        ...
        try:
            ...
            if "parameter group" in str(e) and not strict:
                print(
                    f"[optimizer load_state_dict] Skipping optimizer state due to architecture mismatch: {e}"
                )
                print(
                    "[optimizer load_state_dict] Optimizer will start from scratch (this is expected when model architecture changes)"
                )
            else:
                raise
