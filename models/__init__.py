...
from .modified_var import ModifiedVAR
...
def build_vae_var(
    ...
    init_std=-1,
    rope_emb=True,
    lvl_emb=True,  # init_std < 0: automated
    rope_norm=32,
...
def build_vae_var_with_ray_adaptation(
    # Shared args
    device,
    patch_nums=(
        1,
        ...
        24,
        32,
    ),  # Ray adaptation uses different patch_nums
    # VQVAE args
    V=4096,
    Cvae=32,
    ch=160,
    ...
    drop_scale_length=None,
    enable_logit_norm=True,
    enable_adaptive_norm=False,  # Typically False for ray adaptation
    train_mode="all",
    rope_theta=100.0,
    vae_ada=False,
    sample_from_idx=9,
    ...
    # Build ModifiedVAR with ray adaptation
    var_wo_ddp = ModifiedVAR(
        vae_local=vae_local,
        depth=depth,
        embed_dim=width,
        num_heads=heads,
